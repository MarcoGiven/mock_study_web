...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'images/hotel1_sample3.jpg', 'path': 'images/hotel1_sample3.jpg'},
    {'name': 'images/hotel1_correct.jpg', 'path': 'images/hotel1_correct.jpg'},
    {'name': 'images/hotel1_sample4.jpg', 'path': 'images/hotel1_sample4.jpg'},
    {'name': 'images/hotel1_gray1.jpg', 'path': 'images/hotel1_gray1.jpg'},
    {'name': 'images/hotel1_gray2.jpeg', 'path': 'images/hotel1_gray2.jpeg'},
    {'name': 'images/hotel1_gray3.jpg', 'path': 'images/hotel1_gray3.jpg'},
    {'name': 'images/hotel1_correctGray.jpg', 'path': 'images/hotel1_correctGray.jpg'},
    {'name': 'images/hotel1_gray4.jpg', 'path': 'images/hotel1_gray4.jpg'},
    {'name': 'images/hotel2_query.jpg', 'path': 'images/hotel2_query.jpg'},
    {'name': 'images/hotel2_sample1.JPEG', 'path': 'images/hotel2_sample1.JPEG'},
    {'name': 'images/hotel2_correct.jpg', 'path': 'images/hotel2_correct.jpg'},
    {'name': 'images/hotel2_sample2.jpg', 'path': 'images/hotel2_sample2.jpg'},
    {'name': 'images/hotel2_sample3.jpg', 'path': 'images/hotel2_sample3.jpg'},
    {'name': 'images/hotel2_sample4.jpeg', 'path': 'images/hotel2_sample4.jpeg'},
    {'name': 'images/hotel2_gray1.JPEG', 'path': 'images/hotel2_gray1.JPEG'},
    {'name': 'images/hotel2_correctGray.jpg', 'path': 'images/hotel2_correctGray.jpg'},
    {'name': 'images/hotel2_gray2.jpg', 'path': 'images/hotel2_gray2.jpg'},
    {'name': 'images/hotel2_gray3.jpg', 'path': 'images/hotel2_gray3.jpg'},
    {'name': 'images/hotel2_gray4.jpeg', 'path': 'images/hotel2_gray4.jpeg'},
    {'name': 'images/hotel3_query.jpg', 'path': 'images/hotel3_query.jpg'},
    {'name': 'images/hotel3_correct.jpg', 'path': 'images/hotel3_correct.jpg'},
    {'name': 'images/hotel3_sample1.jpg', 'path': 'images/hotel3_sample1.jpg'},
    {'name': 'images/hotel3_sample2.jpeg', 'path': 'images/hotel3_sample2.jpeg'},
    {'name': 'images/hotel3_sample3.jpg', 'path': 'images/hotel3_sample3.jpg'},
    {'name': 'images/hotel3_sample4.jpg', 'path': 'images/hotel3_sample4.jpg'},
    {'name': 'images/hotel3_correctGray.jpg', 'path': 'images/hotel3_correctGray.jpg'},
    {'name': 'images/hotel3_gray1.jpg', 'path': 'images/hotel3_gray1.jpg'},
    {'name': 'images/hotel3_gray2.jpeg', 'path': 'images/hotel3_gray2.jpeg'},
    {'name': 'images/hotel3_gray3.jpg', 'path': 'images/hotel3_gray3.jpg'},
    {'name': 'images/hotel3_gray4.jpg', 'path': 'images/hotel3_gray4.jpg'},
    {'name': 'images/hotel4_query.jpg', 'path': 'images/hotel4_query.jpg'},
    {'name': 'images/hotel4_sample1.jpg', 'path': 'images/hotel4_sample1.jpg'},
    {'name': 'images/hotel4_sample2.jpg', 'path': 'images/hotel4_sample2.jpg'},
    {'name': 'images/hotel4_sample3.jpg', 'path': 'images/hotel4_sample3.jpg'},
    {'name': 'images/hotel4_sample4.jpg', 'path': 'images/hotel4_sample4.jpg'},
    {'name': 'images/hotel4_correct.jpg', 'path': 'images/hotel4_correct.jpg'},
    {'name': 'images/hotel4_gray1.jpg', 'path': 'images/hotel4_gray1.jpg'},
    {'name': 'images/hotel4_gray2.jpg', 'path': 'images/hotel4_gray2.jpg'},
    {'name': 'images/hotel4_gray3.jpg', 'path': 'images/hotel4_gray3.jpg'},
    {'name': 'images/hotel4_gray4.jpg', 'path': 'images/hotel4_gray4.jpg'},
    {'name': 'images/hotel4_correctGray.jpg', 'path': 'images/hotel4_correctGray.jpg'},
    {'name': 'images/hotel5_query.jpg', 'path': 'images/hotel5_query.jpg'},
    {'name': 'images/hotel5_sample1.jpg', 'path': 'images/hotel5_sample1.jpg'},
    {'name': 'images/hotel5_sample2.jpg', 'path': 'images/hotel5_sample2.jpg'},
    {'name': 'images/hotel5_correct.jpg', 'path': 'images/hotel5_correct.jpg'},
    {'name': 'images/hotel5_sample3.png', 'path': 'images/hotel5_sample3.png'},
    {'name': 'images/hotel5_sample4.jpg', 'path': 'images/hotel5_sample4.jpg'},
    {'name': 'images/hotel5_gray1.jpg', 'path': 'images/hotel5_gray1.jpg'},
    {'name': 'images/hotel5_gray2.jpg', 'path': 'images/hotel5_gray2.jpg'},
...
async function experimentInit() {
  ...
  // Randomly pick one of the groups
  const group = groups[Math.floor(Math.random() * groups.length)];
  
  // Store it in the experiment data
...
function colorBlockLoopBegin(colorBlockLoopScheduler, snapshot) {
  return async function() {
    ...
    colorBlock = new TrialHandler({
      psychoJS: psychoJS,
      nReps:  (group === 'color_only') ? 1 : 0 , method: TrialHandler.Method.RANDOM,
...
function grayBlockLoopBegin(grayBlockLoopScheduler, snapshot) {
  return async function() {
    ...
    grayBlock = new TrialHandler({
      psychoJS: psychoJS,
      nReps: (group === 'gray_only') ? 1 : 0 , method: TrialHandler.Method.RANDOM,
      extraInfo: expInfo, originPath: undefined,
      trialList: undefined,
...
function bothBlockLoopBegin(bothBlockLoopScheduler, snapshot) {
  return async function() {
    ...
    bothBlock = new TrialHandler({
      psychoJS: psychoJS,
      nReps: (group === 'both_blocks') ? 1 : 0 , method: TrialHandler.Method.RANDOM,
      extraInfo: expInfo, originPath: undefined,
      trialList: undefined,
...
function trialsGray_ColorLoopBegin(trialsGray_ColorLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trialsGray_Color.forEach(function() {
...
function trialColorRoutineBegin(snapshot) {
  return async function () {
    ...
    trialColorComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trialGrayscaleRoutineBegin(snapshot) {
  return async function () {
    ...
    trialGrayscaleComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NextScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    NextScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trialColor_GrayRoutineBegin(snapshot) {
  return async function () {
    ...
    trialColor_GrayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
